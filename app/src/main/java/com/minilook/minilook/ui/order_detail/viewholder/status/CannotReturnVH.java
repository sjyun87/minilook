...
public class CannotReturnVH extends _BaseViewHolder<OrderProductDataModel> {
    ...
    public CannotReturnVH(@NonNull View itemView) {
        super(LayoutInflater.from(itemView.getContext())
            .inflate(R.layout.item_order_type_cannot_return, (ViewGroup) itemView, false));
    }
