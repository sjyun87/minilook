...
public class ReturnVH extends _BaseViewHolder<OrderProductDataModel> {
    ...
    public ReturnVH(@NonNull View itemView) {
        super(LayoutInflater.from(itemView.getContext())
            .inflate(R.layout.item_order_type_return, (ViewGroup) itemView, false));
    }
