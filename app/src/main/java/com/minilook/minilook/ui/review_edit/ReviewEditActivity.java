...
public class ReviewEditActivity extends BaseActivity implements ReviewEditPresenter.View {

    public static void start(Context context, ReviewDataModel data) {
    ...
    private ActivityReviewEditBinding binding;
    private ReviewEditPresenter presenter;
    ...
    @Override protected void createPresenter() {
        presenter = new ReviewEditPresenterImpl(provideArguments());
        getLifecycle().addObserver(presenter);
    }

    private ReviewEditArguments provideArguments() {
        return ReviewEditArguments.builder()
            .view(this)
