...
public class ExchangeNReturnReasonItemVH extends _BaseViewHolder<CodeDataModel> {

    @BindView(R.id.txt_name) TextView nameTextView;

    public ExchangeNReturnReasonItemVH(@NonNull View itemView) {
    ...
    private void onItemClick(View view) {
        RxBus.send(new OrderExchangeNReturnPresenterImpl.RxEventSelectedReason(data));
    }
}
