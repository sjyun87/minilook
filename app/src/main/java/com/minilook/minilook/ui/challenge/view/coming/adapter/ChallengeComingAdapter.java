package com.minilook.minilook.ui.challenge.view.coming.adapter;
...
import com.minilook.minilook.ui.challenge.view.coming.viewholder.ChallengeComingItemVH;
import java.util.ArrayList;
import java.util.List;

public class ChallengeComingAdapter extends RecyclerView.Adapter<ChallengeComingItemVH> implements
    ...
    @NonNull @Override public ChallengeComingItemVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ChallengeComingItemVH(parent);
    }

    @Override public void onBindViewHolder(@NonNull ChallengeComingItemVH holder, int position) {
