...
public class PreorderDetailProductAdapter extends RecyclerView.Adapter<PreorderDetailProductVH>
    ...
    @NonNull @Override public PreorderDetailProductVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new PreorderDetailProductVH(parent);
    }

    @Override public void onBindViewHolder(@NonNull PreorderDetailProductVH holder, int position) {
