...
public class MarketTrendItemVH extends _BaseViewHolder<ProductDataModel> {
    ...
    public MarketTrendItemVH(@NonNull View itemView) {
        super(LayoutInflater.from(itemView.getContext())
            .inflate(R.layout.item_market_trend_item, (ViewGroup) itemView, false));
    }
