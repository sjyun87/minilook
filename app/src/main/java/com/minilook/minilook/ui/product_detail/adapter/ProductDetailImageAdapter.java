...
import com.minilook.minilook.ui.product_detail.viewholder.ProductDetailImageVH;
import java.util.ArrayList;
import java.util.List;

public class ProductDetailImageAdapter extends RecyclerView.Adapter<ProductDetailImageVH>
    implements BaseAdapterDataModel<String>, BaseAdapterDataView<String> {

    private List<String> items = new ArrayList<>();

    @NonNull @Override public ProductDetailImageVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ProductDetailImageVH(parent);
    }

    @Override public void onBindViewHolder(@NonNull ProductDetailImageVH holder, int position) {
