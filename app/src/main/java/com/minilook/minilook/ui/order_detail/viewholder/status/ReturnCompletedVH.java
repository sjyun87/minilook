...
public class ReturnCompletedVH extends _BaseViewHolder<OrderProductDataModel> {
    ...
    public ReturnCompletedVH(@NonNull View itemView) {
        super(LayoutInflater.from(itemView.getContext())
            .inflate(R.layout.item_order_type_return_completed, (ViewGroup) itemView, false));
    }
