...
public class MarketNewArrivalsItemVH extends _BaseViewHolder<ProductDataModel> {
    ...
    public MarketNewArrivalsItemVH(@NonNull View itemView) {
        super(LayoutInflater.from(itemView.getContext())
            .inflate(R.layout.item_market_new_arrivals_item, (ViewGroup) itemView, false));
    }
