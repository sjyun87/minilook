...
import com.minilook.minilook.ui.order_exchange_n_return.viewholder.ExchangeNReturnTypeItemVH;
import java.util.ArrayList;
import java.util.List;

public class ExchangeNReturnTypeAdapter extends RecyclerView.Adapter<ExchangeNReturnTypeItemVH>
    ...
    @NonNull @Override public ExchangeNReturnTypeItemVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ExchangeNReturnTypeItemVH(parent);
    }

    @Override public void onBindViewHolder(@NonNull ExchangeNReturnTypeItemVH holder, int position) {
