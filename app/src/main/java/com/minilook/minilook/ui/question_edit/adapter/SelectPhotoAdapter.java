package com.minilook.minilook.ui.question_edit.adapter;
...
import com.minilook.minilook.ui.question_edit.viewholder.SelectPhotoItemVH;
import java.util.ArrayList;
import java.util.List;

public class SelectPhotoAdapter extends RecyclerView.Adapter<SelectPhotoItemVH> implements
    ...
    @NonNull @Override
    public SelectPhotoItemVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new SelectPhotoItemVH(parent);
    }

    @Override public void onBindViewHolder(@NonNull SelectPhotoItemVH holder, int position) {
