package com.minilook.minilook.ui.challenge.view.open.adapter;
...
import com.minilook.minilook.ui.challenge.view.open.viewholder.ChallengeOpenItemVH;
import java.util.ArrayList;
import java.util.List;

public class ChallengeOpenAdapter extends RecyclerView.Adapter<ChallengeOpenItemVH> implements
    ...
    @NonNull @Override public ChallengeOpenItemVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ChallengeOpenItemVH(parent);
    }

    @Override public void onBindViewHolder(@NonNull ChallengeOpenItemVH holder, int position) {
