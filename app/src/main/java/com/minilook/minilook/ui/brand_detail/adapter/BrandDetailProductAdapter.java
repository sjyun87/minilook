...
import com.minilook.minilook.ui.brand_detail.viewholder.BrandDetailProductVH;
import java.util.ArrayList;
import java.util.List;

public class BrandDetailProductAdapter extends RecyclerView.Adapter<BrandDetailProductVH>
    ...
    @NonNull @Override public BrandDetailProductVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new BrandDetailProductVH(parent);
    }

    @Override public void onBindViewHolder(@NonNull BrandDetailProductVH holder, int position) {
