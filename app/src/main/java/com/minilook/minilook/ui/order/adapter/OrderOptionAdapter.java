...
import com.minilook.minilook.ui.order.viewholder.OrderOptionItemVH;
import java.util.ArrayList;
import java.util.List;

public class OrderOptionAdapter extends RecyclerView.Adapter<OrderOptionItemVH>
    ...
    @NonNull @Override public OrderOptionItemVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new OrderOptionItemVH(parent);
    }

    @Override public void onBindViewHolder(@NonNull OrderOptionItemVH holder, int position) {
