package com.minilook.minilook.ui.search_keyword.adapter;
...
public class RecentKeywordAdapter extends RecyclerView.Adapter<RecentKeywordVH>
    implements BaseAdapterDataModel<String>, BaseAdapterDataView<String> {

    private final List<String> items = new ArrayList<>();

    @NonNull @Override public RecentKeywordVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new RecentKeywordVH(parent);
    }

    @Override public void onBindViewHolder(@NonNull RecentKeywordVH holder, int position) {
