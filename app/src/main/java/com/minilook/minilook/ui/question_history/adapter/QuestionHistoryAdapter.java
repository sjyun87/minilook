...
public class QuestionHistoryAdapter extends RecyclerView.Adapter<QuestionHistoryItemVH>
    ...
    @NonNull @Override public QuestionHistoryItemVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new QuestionHistoryItemVH(parent);
    }

    @Override public void onBindViewHolder(@NonNull QuestionHistoryItemVH holder, int position) {
