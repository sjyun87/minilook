...
public class CannotExchangeVH extends _BaseViewHolder<OrderProductDataModel> {
    ...
    public CannotExchangeVH(@NonNull View itemView) {
        super(LayoutInflater.from(itemView.getContext())
            .inflate(R.layout.item_order_type_cannot_exchange, (ViewGroup) itemView, false));
    }
