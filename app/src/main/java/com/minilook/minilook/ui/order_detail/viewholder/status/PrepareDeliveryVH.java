...
public class PrepareDeliveryVH extends _BaseViewHolder<OrderProductDataModel> {
    ...
    public PrepareDeliveryVH(@NonNull View itemView) {
        super(LayoutInflater.from(itemView.getContext())
            .inflate(R.layout.item_order_type_prepare_delivery, (ViewGroup) itemView, false));
    }
