...
public class CancelVH extends _BaseViewHolder<OrderProductDataModel> {
    ...
    public CancelVH(@NonNull View itemView) {
        super(LayoutInflater.from(itemView.getContext())
            .inflate(R.layout.item_order_type_cancel, (ViewGroup) itemView, false));
    }
