...
public class ProductNoBrandVH extends BaseViewHolder<ProductDataModel> {
    ...
    public ProductNoBrandVH(@NonNull View itemView) {
        super(LayoutInflater.from(itemView.getContext())
            .inflate(R.layout.item_product_type_no_brand, (ViewGroup) itemView, false));
    }
