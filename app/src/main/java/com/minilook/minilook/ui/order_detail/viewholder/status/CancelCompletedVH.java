...
public class CancelCompletedVH extends _BaseViewHolder<OrderProductDataModel> {
    ...
    public CancelCompletedVH(@NonNull View itemView) {
        super(LayoutInflater.from(itemView.getContext())
            .inflate(R.layout.item_order_type_cancel_completed, (ViewGroup) itemView, false));
    }
