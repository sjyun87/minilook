...
import com.minilook.minilook.ui.product_detail.viewholder.ProductDetailReviewItemVH;
import java.util.ArrayList;
import java.util.List;

public class ProductDetailReviewAdapter extends RecyclerView.Adapter<ProductDetailReviewItemVH>
    ...
    @NonNull @Override public ProductDetailReviewItemVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ProductDetailReviewItemVH(parent);
    }

    @Override public void onBindViewHolder(@NonNull ProductDetailReviewItemVH holder, int position) {
