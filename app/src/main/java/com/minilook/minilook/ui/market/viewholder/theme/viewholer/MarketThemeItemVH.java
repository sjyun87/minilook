...
import com.minilook.minilook.databinding.ViewMarketThemeItemBinding;
...
public class MarketThemeItemVH extends BaseViewHolder<ProductDataModel> {
    ...
    private final ViewMarketThemeItemBinding binding;

    public MarketThemeItemVH(@NonNull View parent) {
        super(ViewMarketThemeItemBinding.inflate(LayoutInflater.from(parent.getContext()), (ViewGroup) parent, false));
        binding = ViewMarketThemeItemBinding.bind(itemView);
    }
